        ...
        <div>
          ...
          <Context>
            <Topics>
              <span>
                {' '}
                <img src={SimpleseSegura} alt="" /> Compra simples e segura
              </span>
              <span>
            ...
            <Topics>
              <span>
                {' '}
                <img src={Entrega} alt="" /> Entrega rápida e rastreada
              </span>
              <span>
                {' '}
                <img src={CaféFresco} alt="" /> O café chega fresquinho até você
              </span>
            </Topics>
          </Context>
        </div>
